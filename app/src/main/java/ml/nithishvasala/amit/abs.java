...
public class abs extends AppCompatActivity {
    ...
    public void changeimge(){
        //image changer
        if(c==1){
            iv.setImageResource(R.drawable.abs1);
            tv_count.setText("1/6");
        }
        else if(c==2){
            iv.setImageResource(R.drawable.abs2);
            tv_count.setText("2/6");
        }
        else if(c==3){
            iv.setImageResource(R.drawable.abs3);
            tv_count.setText("3/6");
        }
        else if(c==4){
            iv.setImageResource(R.drawable.abs4);
            tv_count.setText("4/6");
        }
        else if(c==5){
            iv.setImageResource(R.drawable.abs5);
            tv_count.setText("5/6");
        }
        else if(c==6){
            iv.setImageResource(R.drawable.abs6);
            tv_count.setText("6/6");
        }
